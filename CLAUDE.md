...
- ▶ **NEXT SESSION (Task 16):** fix options for SVGs failing the Planck >12 verdict + a new `fix` status (enum migration) to pull failing items out of Approved/export scope. See [Dev_Tasks.md](Dev_Tasks.md) Task 16
