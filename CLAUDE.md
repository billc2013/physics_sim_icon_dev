...
- Both emit `type:"convex"` with the raw ordered ring, **no hull**. **Convex blobs (asteroid, balls) should use the circle / ≤12-hull auto-fit instead** — silhouette over-produces vertices there and yields a convex over-cap polygon Planck can't take.
